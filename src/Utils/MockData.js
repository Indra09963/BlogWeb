const blogs = [
  ...
  },
  {
  ...
  },
   {
    ...
    title: "China Travel",
    category: "Travelling",
    content: "China offers an extraordinary travel experience with its blend of ancient history, vibrant culture, and modern marvels. Visitors can explore iconic landmarks like the Great Wall, Forbidden City, and Terracotta Warriors. The country boasts breathtaking natural beauty, from the karst mountains of Guilin to the serene lakes of Hangzhou. Bustling cities like Beijing, Shanghai, and Xi’an showcase China's rapid development and rich heritage. Delicious regional cuisines, including Peking duck and dim sum, delight food lovers. Efficient transport systems, including high-speed trains, make travel convenient. Engaging with local traditions, festivals, and crafts provides deeper cultural insight, making China a truly unforgettable destination",
    previewDescription: "Discover China’s rich culture, history, cuisine, and scenic beauty"
